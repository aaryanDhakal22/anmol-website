...
class NewStudentTest(TestCase):
    def test_can_save_a_POST_request(self):
        response = self.client.post(path='/api/student/',data={
    ...
    def test_can_handle_GET_request(self):
        ...
        response = self.client.post('/api/student/',data={
    ...
    def test_can_update_data(self):
        testStudentId = "asectyler4a10b"
        testAddress = "Bloomington, Mali"
        self.client.post('/api/student/',data={
            "studentId": testStudentId,
            "name": "Tyler Matther",
            "phone": 9991327884,
            "gender": "M",
        ...
        self.client.put('/api/student/details/'+testStudentId,data={
            "studentId": testStudentId,
            "name": "Tyler Matthew",
            "phone": 9991327884,
            "gender": "M",
